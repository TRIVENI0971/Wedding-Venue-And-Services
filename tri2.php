        ...
        <div class="col-md-8 p-0" style="margin-bottom: 20px;"> <!-- border:1px solid rgba(0,0,0,.125) -->
            ...
            <div class="float-left bg-white">
                <h5 class="h5 text-uppercase mb-5 pt-3 pl-3 pr-3">
                    <span class="float-left text-capitalize">Charming Wedding Hall</span>
                    <span class="float-right text-capitalize">Price:9,00,000 RS.</span>
                </h5>
                <img src="admin/upload/gallery/wed2.jpg" style="width: 700px;" alt="">

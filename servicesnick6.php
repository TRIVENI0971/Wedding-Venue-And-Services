...
<div class="row">
        <div class="col-md-12 p-0" style="margin-bottom: 20px;"> <!-- border:1px solid rgba(0,0,0,.125) -->
            ...
            <div class="float-left">
                <img src="admin/upload/gallery/wed7.jpeg" style="width: 600px;" alt="">
            </div>
    </div>
    ...
    <div class="float-left" style="width: 600px;"> 
                <ul class="list-group">
                    <li class="list-group-item bg-danger active" style="padding-top: 12px;"><h6 class="h6 text-center">Rooms</h6></li>
                                                                <li class="list-group-item"><h6>No Of Rooms   &nbsp;  &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; - &nbsp;  23 </h6> </li>
    ...
    We cater to Hyderbad,Visakhapatnam,Bengaluru,Udaipur,Guntur,East Godavari,Vijayawada,West Godavari.</h6> </li>

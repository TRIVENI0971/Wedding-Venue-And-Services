...
<div class="row">
        <div class="col-md-12 p-0" style="margin-bottom: 20px;"> <!-- border:1px solid rgba(0,0,0,.125) -->
            ...
            <div class="float-left">
                <img src="admin/upload/gallery/wed2.jpg" style="width: 600px;" alt="">
            </div>
    </div>
    ...
    <div class="float-left" style="width: 600px;"> 
                <ul class="list-group">
                    <li class="list-group-item bg-danger active" style="padding-top: 12px;"><h6 class="h6 text-center">Hall Capacity</h6></li>
                                                                <li class="list-group-item"><h6>Hall Seating Nos   &nbsp;  &nbsp; &nbsp; &nbsp; - &nbsp;   2100 </h6> </li>
                                            <li class="list-group-item"><h6>Hall Floating Nos    &nbsp;  &nbsp; &nbsp; &nbsp; - &nbsp;   3100</h6></li>
    ...
    <div class="float-left" style="width: 600px;"> 
                <ul class="list-group">
                    <li class="list-group-item bg-danger active" style="padding-top: 12px;"><h6 class="h6 text-center">Parking</h6></li>
                                                                <li class="list-group-item"><h6>Car Parking  &nbsp;  &nbsp; &nbsp; &nbsp; - &nbsp;   90 </h6> </li>
   ...
   We cater to Hyderbad,Anantapur,Visakhapatnam,Bengaluru,Udaipur,Guntur,East Godavari,West Godavari.</h6> </li>
